...
using DotNetCleanTemplate.Gateway.Features.Transformers;
...
namespace DotNetCleanTemplate.Gateway.Features.Core;
    ...
    extension(IHostApplicationBuilder builder)
    {
        ...
        public IHostApplicationBuilder AddAuthenticationSchemes()
        {
            builder.Services.AddAuthentication(options =>
                ...
                {
                    options.Cookie.Name = "__DotNetCleanTemplate_TOKEN";
